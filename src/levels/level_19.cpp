...
void Level_19::create_level()
{
    setup_player(Vector2f{150.0F, 450.0F});
    clear_com_box();
    camera_.set_borders({0.0F, 0.0F}, {1000.0F, 200.0F});
}

void Level_19::update_level(double delta_time)
{
...
void Level_19::draw_level(double delta_time)
{
    plat_1_.draw();
    plat_2_.draw();
    plat_3_.draw();
...
std::unique_ptr<rinvid::Screen> Level_19::restart_level() const
{
    return Levels::level_19();
}
