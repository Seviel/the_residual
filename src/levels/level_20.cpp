...
void Level_20::create_level()
{
    setup_player(Vector2f{150.0F, 580.0F});
    clear_com_box();
    camera_.set_borders({0.0F, 0.0F}, {1000.0F, 300.0F});
}

void Level_20::update_level(double delta_time)
{
...
void Level_20::draw_level(double delta_time)
{
...
std::unique_ptr<rinvid::Screen> Level_20::restart_level() const
{
    return Levels::level_20();
}
