...
class Level_24 : public PlayableLevel
{
  ...
  private:
    ...
    Texture background_texture_{"resources/gfx/level_24.png"};
    Sprite background_sprite_{&background_texture_, 1800, 800, Vector2f{-100.0F, 0.0F},
                              Vector2f{0.0F, 0.0F}};
    ...
    TextTrigger op_trig_1_{GameText::LVL_24_OP_1, Vector2f{750.0F, 500.0F}, 50, 200,
                           TextRole::Operator};
    TextTrigger op_trig_2_{GameText::LVL_24_OP_2, Vector2f{300.0F, 500.0F}, 50, 200,
                           TextRole::Operator};
    TextTrigger op_trig_3_{GameText::LVL_24_OP_3, Vector2f{1150.0F, 500.0F}, 50, 200,
                           TextRole::Operator};
