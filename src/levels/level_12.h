...
class Level_12 : public PlayableLevel
{
  ...
  private:
    ...
    Texture background_texture_{"resources/gfx/level_12.png"};
    Sprite background_sprite_{&background_texture_, 2400, 1800, Vector2f{0.0F, 0.0F},
                              Vector2f{0.0F, 0.0F}};
    ...
    TextTrigger player_trig_1_{GameText::LVL_12_PLAYER_1, Vector2f{650.0F, 250.0F}, 50, 200,
                               TextRole::Player};
    TextTrigger glitch_trig_1_{GameText::LVL_12_GLITCH_1, Vector2f{200.0F, 1500.0F}, 50, 200,
