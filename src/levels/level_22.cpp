...
void Level_22::update_level(double delta_time)
{
...
void Level_22::draw_level(double delta_time)
{
...
std::unique_ptr<rinvid::Screen> Level_22::restart_level() const
{
    return Levels::level_22();
}
