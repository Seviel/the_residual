...
void Level_12::create_level()
{
    setup_player(Vector2f{150.0F, 100.0F});
    clear_com_box();
    camera_.set_borders({0.0F, 0.0F}, {1600.0F, 1200.0F});
}

void Level_12::update_level(double delta_time)
{
    ...
    glitch_trig_1_.update(delta_time);
    ...
    collide_player_with(glitch_trig_1_, TextTrigger::activate_on_collision);
...
void Level_12::draw_level(double delta_time)
{
...
std::unique_ptr<rinvid::Screen> Level_12::restart_level() const
{
    return Levels::level_12();
}
